...
class AdminPageFramework_Form_term_meta extends AdminPageFramework_Form_Meta {
    ...
    public function get() {
        ...
        $_sClassSelectors = 'recipepress-reloaded-form-table-term_meta' . $_sAddNewTerm;
        return '<tr class="recipepress-reloaded-form-table-outer-row-term_meta">' . '<td colspan=2>' . '<table class="' . $_sClassSelectors . '">' . '<tbody>' . '<tr>' . '<td>' . $_oFormTables->get() . '</td>' . '</tr>' . '</tbody>' . '</table>' . '</td>' . '</tr>';
    }
}
