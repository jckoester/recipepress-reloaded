...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".recipepress-reloaded-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.recipepress-reloaded-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.recipepress-reloaded-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.recipepress-reloaded-field .taxonomy-checklist ul ul {margin-left: 1em;}.recipepress-reloaded-field .taxonomy-checklist-label {white-space: nowrap; }.recipepress-reloaded-field .tab-box-container.categorydiv {max-height: none;}.recipepress-reloaded-field .tab-box-tab-text {display: inline-block;font-size: 13px;font-size: smaller;padding: 2px;}.recipepress-reloaded-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.recipepress-reloaded-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 4px;background-color: #fff;}.recipepress-reloaded-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.recipepress-reloaded-field .tab-box-tabs li a { color: #333; text-decoration: none; }.recipepress-reloaded-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.recipepress-reloaded-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.recipepress-reloaded-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.recipepress-reloaded-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.recipepress-reloaded-field .tab-box-content:target, .recipepress-reloaded-field .tab-box-content:target, .recipepress-reloaded-field .tab-box-content:target { display: block; }.recipepress-reloaded-field .tab-box-content .select_all_button_container, .recipepress-reloaded-field .tab-box-content .select_none_button_container{display: inline-block;margin-top: 0.8em;}.recipepress-reloaded-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
