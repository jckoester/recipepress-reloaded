...
class AdminPageFramework_FieldType_text extends AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".recipepress-reloaded-field.recipepress-reloaded-field-text > .recipepress-reloaded-input-label-container {vertical-align: middle; }.recipepress-reloaded-field.recipepress-reloaded-field-text > .recipepress-reloaded-input-label-container.recipepress-reloaded-field-text-multiple-labels {display: block;}";
    }
    ...
    private function _getFieldOutputByLabel($sKey, $sLabel, $aField) {
        ...
        $_sClassSelector = $_bIsArray ? 'recipepress-reloaded-field-text-multiple-labels' : '';
        ...
        $_aOutput = array($this->getElementByLabel($aField['before_label'], $sKey, $aField['label']), "<div class='recipepress-reloaded-input-label-container {$_sClassSelector}'>", "<label for='" . $_aInputAttributes['id'] . "'>", $this->getElementByLabel($aField['before_input'], $sKey, $aField['label']), $_sLabel ? "<span " . $this->getLabelContainerAttributes($aField, 'recipepress-reloaded-input-label-string') . ">" . $_sLabel . "</span>" : '', "<input " . $this->getAttributes($_aInputAttributes) . " />", $this->getElementByLabel($aField['after_input'], $sKey, $aField['label']), "</label>", "</div>", $this->getElementByLabel($aField['after_label'], $sKey, $aField['label']),);
        return implode('', $_aOutput);
    }
}
