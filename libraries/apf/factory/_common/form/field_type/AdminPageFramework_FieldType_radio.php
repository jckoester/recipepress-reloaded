...
class AdminPageFramework_FieldType_radio extends AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".recipepress-reloaded-field input[type='radio'] {margin-right: 0.5em;} .recipepress-reloaded-field-radio .recipepress-reloaded-input-label-container {padding-right: 1em;} .recipepress-reloaded-field-radio .recipepress-reloaded-input-container {display: inline;} .recipepress-reloaded-field-radio .recipepress-reloaded-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.recipepress-reloaded-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
