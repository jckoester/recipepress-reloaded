...
class AdminPageFramework_FieldType_import extends AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".recipepress-reloaded-field-import input {margin-right: 0.5em;}.recipepress-reloaded-field-import label,.form-table td fieldset.recipepress-reloaded-fieldset .recipepress-reloaded-field-import label { display: inline; }";
    }
