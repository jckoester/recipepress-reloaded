...
class AdminPageFramework_FieldType_submit extends AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".recipepress-reloaded-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'recipepress-reloaded-input-label-container' . ' recipepress-reloaded-input-button-container' . ' recipepress-reloaded-input-container',);
    }
