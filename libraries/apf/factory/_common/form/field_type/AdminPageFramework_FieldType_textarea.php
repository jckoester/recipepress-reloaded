...
jQuery( document ).ready( function(){
    ...
    jQuery().registerAdminPageFrameworkCallbacks( {	
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Elements
            var _oField              = oCloned.closest( '.recipepress-reloaded-field' );
        ...
        stopped_sorting_fields : function( oSortedFields, sFieldType, sFieldsTagID, iCallType ) { 
            ...
            // Update the editor.
            setTimeout(function(){
                var _oFields = oSortedFields.children( '.recipepress-reloaded-field' );
        ...
        stopped_sorting_sections: function( oSections ) {
            ...
            setTimeout(function(){
                var _oFields = jQuery( oSections ).find( '.recipepress-reloaded-field' );
                updateFoundEditors( _oFields );           
            }, 100 );
        ...
        saved_widget : function( oWidget ) { 
            ...
            jQuery( oWidget ).find( '.recipepress-reloaded-field' ).each( function( iIndex ) {
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".recipepress-reloaded-field-textarea .recipepress-reloaded-input-label-string {vertical-align: top;margin-top: 2px;} .recipepress-reloaded-field-textarea .wp-core-ui.wp-editor-wrap {margin-bottom: 0.5em;}.recipepress-reloaded-field-textarea.recipepress-reloaded-field .recipepress-reloaded-input-label-container {vertical-align: top; float: left;clear: both;} .postbox .recipepress-reloaded-field-textarea .recipepress-reloaded-input-label-container {width: 100%;}.recipepress-reloaded-field-textarea textarea {max-width: 100%;}";
    }
    ...
    private function _getFieldOutputByLabel($sKey, $sLabel, $aField) {
        ...
        $_sClassSelector = $_bIsArray ? 'recipepress-reloaded-field-textarea-multiple-labels' : '';
        ...
        $_aOutput = array($this->getElementByLabel($aField['before_label'], $sKey, $aField['label']), "<div class='recipepress-reloaded-input-label-container {$_sClassSelector}'>", "<label for='" . $aField['attributes']['id'] . "'>", $this->getElementByLabel($aField['before_input'], $sKey, $aField['label']), $_sLabel ? "<span " . $this->getLabelContainerAttributes($aField, 'recipepress-reloaded-input-label-string') . ">" . $_sLabel . "</span>" : '', $this->_getEditor($aField), $this->getElementByLabel($aField['after_input'], $sKey, $aField['label']), "</label>", "</div>", $this->getElementByLabel($aField['after_label'], $sKey, $aField['label']),);
        return implode('', $_aOutput);
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='recipepress-reloaded-textarea-enabler'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
