...
class AdminPageFramework_Form_View___FieldTitle extends AdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_aLabelAttributes = array('class' => $this->getClassAttribute('recipepress-reloaded-field-title', $this->aClassSelectors), 'for' => $_oInputTagIDGenerator->get(),);
