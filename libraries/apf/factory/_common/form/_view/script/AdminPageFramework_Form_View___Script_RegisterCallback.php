...
(function ( $ ) {
     ...
     */  
    $( document ).bind( 'recipepress-reloaded_added_repeatable_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){          
     ...
     * 
     * Unlike the `recipepress-reloaded_added_repeatable_field` event, this does not call the callback function
     ...
     */
    $( document ).bind( 'recipepress-reloaded_repeated_field', function( oEvent, iCallType, oModelContainer ){
     ...
     * @since       3.8.0
     */
    $( document ).bind( 'recipepress-reloaded_stopped_sorting_sections', function( oEvent ){  
     ...
     */
    /* $( document ).bind( 'recipepress-reloaded_removed_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){
        var _oThisNode = jQuery( oEvent.target );
     ...
     * @since    3.2.0 
     */
    $( document ).bind( 'recipepress-reloaded_saved_widget', function( event, oWidget ){
