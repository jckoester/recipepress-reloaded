...
(function($) {
    $.fn.enableAdminPageFrameworkSortableSections = function( sSectionsContainerID ) {
        ...
        var _bIsTabbed      = _oTarget.hasClass( 'recipepress-reloaded-section-tabs-contents' );
        var _bCollapsible   = 0 < _oTarget.children( '.recipepress-reloaded-section.is_subsection_collapsible' ).length;

        var _oTarget        = _bIsTabbed
            ? _oTarget.find( 'ul.recipepress-reloaded-section-tabs' )
            : _oTarget;
        ...
        var _aSortableOptions = { 
                items: _bIsTabbed
                    ? '> li:not( .disabled )'
                    : '> div:not( .disabled, .recipepress-reloaded-collapsible-toggle-all-button-container )', 
                handle: _bCollapsible
                    ? '.recipepress-reloaded-section-caption'
                    : false,
                ...
                stop: function(e,ui) {
                    ...
                    jQuery( this ).trigger( 
                        'recipepress-reloaded_stopped_sorting_sections', 
                ...
                // cancel: '.recipepress-reloaded-section-description, .recipepress-reloaded-section-title'
        ...
        if ( ! _bIsTabbed ) {
            ...
            _oSortable.bind( 'sortstop', function() {
                ...
                jQuery( this ).find( 'caption > .recipepress-reloaded-section-title:not(.recipepress-reloaded-collapsible-sections-title,.recipepress-reloaded-collapsible-section-title)' ).first().show();
                jQuery( this ).find( 'caption > .recipepress-reloaded-section-title:not(.recipepress-reloaded-collapsible-sections-title,.recipepress-reloaded-collapsible-section-title)' ).not( ':first' ).hide();
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='recipepress-reloaded-section-sortable-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
