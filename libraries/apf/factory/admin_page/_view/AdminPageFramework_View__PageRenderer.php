...
class AdminPageFramework_View__PageRenderer extends AdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        ...
        <div class="<?php echo esc_attr($this->oFactory->oProp->sWrapperClassAttribute); ?>">
            ...
            <div class="recipepress-reloaded-container">    
                <?php
        ...
        $this->_printPageMetaBoxes(); ?>     
            ...
            </div><!-- .recipepress-reloaded-container -->
    ...
    private function _printMainPageContent($sPageSlug, $sTabSlug) {
        ...
        echo "<div class='recipepress-reloaded-content'>";
        ...
        echo "</div><!-- .recipepress-reloaded-content -->";
    }
    ...
    private function _printFormOpeningTag($fEnableForm = true) {
        ...
        echo "<form " . $this->getAttributes(array('method' => 'post', 'enctype' => $this->oFactory->oProp->sFormEncType, 'id' => 'recipepress-reloaded-form', 'action' => wp_unslash(remove_query_arg('settings-updated', $this->oFactory->oProp->sTargetFormPage)),)) . " >" . PHP_EOL;
