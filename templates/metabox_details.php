...
<div class="detailsbox">
     ...
     <div class="recipe_details_row rpr_servings">
     	...
     	<input type="number" name="rpr_recipe_servings" id="rpr_recipe_servings" value="<?php echo $servings; ?>" />
        <input type="text" name="rpr_recipe_servings_type" id="rpr_recipe_servings_type" value="<?php echo $servings_type; ?>" />
        <span class="recipe-general-form-notes" id="servings_note"> <?php _e( '(e.g. 2 people, 3 loafs, ...)', $this->pluginName ) ?></span>
     </div>
     <div class="recipe_details_row">
     	<label for="rpr_recipe_prep_time"><?php _e( 'Prep Time', $this->pluginName ); ?></label>
     	<input type="number" name="rpr_recipe_prep_time" id="rpr_recipe_prep_time" value="<?php echo $prep_time; ?>" />
     ...
     <div class="recipe_details_row">
     	...
     	<input type="number" name="rpr_recipe_cook_time" id="rpr_recipe_cook_time" value="<?php echo $cook_time; ?>" />
        <span class="recipe-general-form-notes"> <?php _e( 'min.', $this->pluginName ) ?></span>
     </div>
     <div class="recipe_details_row">
     	<label for="rpr_recipe_passive_time"><?php _e( 'Passive Time', $this->pluginName ); ?></label>
     	<input type="number" name="rpr_recipe_passive_time" id="rpr_recipe_passive_time" value="<?php echo $passive_time; ?>" />
        <span class="recipe-general-form-notes"> <?php _e( 'min.', $this->pluginName ) ?></span>
     </div>
     <div class="recipe_details_row">
