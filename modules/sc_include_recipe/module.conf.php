...
$module_config = array(
    ...
    'title'         => __( 'Include recipe in posts and pages', 'recipepress-reloaded' ),
    // REQUIRED: a short description of what this module does
    'description'   => __( 'Provides a shortcode to include recipes posts and pages.', 'recipepress-reloaded'),
