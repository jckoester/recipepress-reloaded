...
/**
 * The general tab of the options page
 *
 ...
 */
class RPR_Options_Page_General {
    ...
    public function __construct( $oFactory ) {
		 ...
		 * Load dependencies:
		 */
		require_once 'class-rpr-options-page-general-general.php';
        ...
        $oFactory->addInPageTabs(    
            ...
            array(
                ...
                'title'     => '<i class="fa fa-cog"></i> ' . __( 'General', 'recipepress-reloaded' ),    
            )    
        );  
    ...
    public function replyToLoadTab( $oFactory ) {
        ...
        $_aClasses = array(
            'RPR_Options_Page_General_General',
        );
