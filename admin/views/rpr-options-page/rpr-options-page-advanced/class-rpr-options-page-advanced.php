...
/**
 * The advanced tab of the options page
 *
 ...
 */
class RPR_Options_Page_Advanced {
	 ...
	 * Load dependcies:
	 */
	include 'class-rpr-options-page-advanced-advanced.php';	
        ...
        $oFactory->addInPageTabs(    
            ...
            array(
                ...
                'title'     => '<i class="fa fa-cogs"></i> ' . __( 'Advanced', 'recipepress-reloaded' ),    
            )    
        );  
    ...
    public function replyToLoadTab( $oFactory ) {
        ...
        $_aClasses = array(
            'RPR_Options_Page_Advanced_Advanced'
        );
