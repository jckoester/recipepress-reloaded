...
$oFactory->addSettingFields(
    ...
    array(
        ...
        'tip'           => __( 'Enter the class or ID of areas or elements that should not be printed. This is highly depending on the wordpress theme you are using. Add here the class (prefixed by \'.\') or the id (prefixed by \'#\') of the area not to be prointed. Separate multiple entries with commas (\',\').', 'recipepress-reloaded' ),
        'default'       => '.no-print'
    )
);