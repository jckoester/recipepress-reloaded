...
?>
    <tr class="ingredient">
        ...
        <td><input type="text"   name="rpr_recipe_ingredients[<?php echo $i; ?>][rpr_ingredient]" class="ingredients_name" id="ingredients_<?php echo $i; ?>" onfocus="autoSuggestTag('ingredients_<?php echo $i; ?>', 'ingredient');"  value="<?php echo $ingredient['ingredient']; ?>" /></td>
        <td>
...
?>
    <tr class="ingredient">
        ...
        <td><input type="text"   name="rpr_recipe_ingredients[<?php echo $i; ?>][rpr_ingredient]" class="ingredients_name" id="ingredients_<?php echo $i; ?>" onfocus="autoSuggestTag('ingredients_<?php echo $i; ?>', 'ingredient');" placeholder="<?php _e( 'olive oil', $this->pluginName ); ?>" /></td>
        <td>
