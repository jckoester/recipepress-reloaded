 ...
 * from the http://themehybrid.com/ project
 *
...
class RPR_Widget_Tag_Cloud extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            'rpr-tag-cloud',
            __( 'Tag Cloud', 'recipepress-reloaded' )
        );
    }
    ...
    function widget( $sidebar, $instance ) {
        ...
        /*if( is_array( $instance['taxonomy'] ) && in_array( 'rpr_ingredient', $instance['taxonomy'] ) ) {
        ...
        <div class="rpr-widget-controls columns-2 column-first">
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>">
                    <?php _e( 'Title:', 'recipe-press-reloaded' ); ?>
                </label>
                <input type="text" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo esc_attr( $instance['title'] ); ?>" />
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'taxonomy' ); ?>" >
                    <?php _e( "Taxonomy:", 'recipepress-reloaded' ); ?>
                </label> 
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'format' ); ?>">
                    <?php _e( "Format:", 'recipepress-reloaded' ); ?>
                </label> 
		<select class="widefat" id="<?php echo $this->get_field_id( 'format' ); ?>" name="<?php echo $this->get_field_name( 'format' ); ?>">
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'order' ); ?>">
                    <?php _e( "Order:", 'recipepress-reloaded' ); ?>
                </label> 
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'orderby' ); ?>">
                    <?php _e( "Order by:", 'recipepress-reloaded') ; ?>
                </label> 
        ...
        <div class="rpr-widget-controls columns-2 column-last">
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'number' ); ?>">
                    <?php _e( "Number:", 'recipepress-reloaded' ); ?>
                </label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'largest' ); ?>">
                    <?php _e( "Largest:", 'recipepress-reloaded' ); ?>
                </label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'smallest' ); ?>">
                    <?php _e( "Smallest:", 'recipepress-reloaded' ); ?>
                </label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'unit' ); ?>">
                    <?php _e( "Unit:", 'recipepress-reloaded'); ?>
                </label> 
		<select class="smallfat" id="<?php echo $this->get_field_id( 'unit' ); ?>" name="<?php echo $this->get_field_name( 'unit' ); ?>">
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'separator' ); ?>">
                    <?php _e( "Separator:", 'recipepress-reloded' ); ?>
                </label>
